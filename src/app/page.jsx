...
export default function Home() {
  ...
  const handleSearch = (e)=>{
    ...
    if(query===""){
      ...
      const filteredData = data.filter(item=>
        item.title.toLowerCase().includes(query)//data ko filter by title
      );
  ...
  return (
    <div  >
        ...
        <div>
          <input type="text" placeholder="Search here" className="border border-gray-300 rounded-lg p-2 focus:outline-none  flex justify-center items-center  " onChange={handleSearch} />
        </div>
